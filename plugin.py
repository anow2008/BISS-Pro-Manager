...
class ScrollText(Screen):
    ...
    def __init__(self,session,text):
        ...
        self["actions"]=ActionMap(
            ...
            {"ok":self.close,"cancel":self.close,"up":self["text"].pageUp,"down":self["text"].pageDown},-1
        )
...
def Plugins(**kwargs):
    return PluginDescriptor(name="BISS Pro v1.0",where=PluginDescriptor.WHERE_PLUGINMENU,fnc=main)
